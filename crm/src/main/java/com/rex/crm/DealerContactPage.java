 ...
 * @author Feiyun Zhou 
 */
public class DealerContactPage extends TemplatePage
{
	/**
	 * Constructor
	 */
	public DealerContactPage()
	{
	    initPage(null);
		
	}
	
	   public DealerContactPage(Map<String,Boolean> map){
	        initPage(map);
	    }
	    
	    private void initPage(Map<String,Boolean> filter){
	        Map<String, Entity> entities = Configuration.getEntityTable();
	        Entity entity = entities.get("dealerContact");
	        ...
	        add(new FilterPanel("filterPanel",types ,filter,DealerContactPage.class));
