...
public class AddEntityPage extends TemplatePage {
    private static final Logger logger = Logger.getLogger(AddEntityPage.class);
    private static final long serialVersionUID = -2613412283023068638L;

    private static int NUM_OF_COLUMN  = 2;
    
    public AddEntityPage(final String entityName, String id){
        ...
        //set relations data
         ...
         for(Relation r:relations){
           ...
           item.add(new RelationDataPanel("relationPanel",r,entityName,list,String.valueOf(lid),null));
